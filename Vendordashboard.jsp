...
header .navbar {
  ...
  <%@page import="java.sql.PreparedStatement" %>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse navbar-light" id="navbarsExample05">
            <ul class="navbar-nav ml-auto pl-lg-5 pl-0">
              <li class="nav-item">
               <strong> <a class="nav-link active" href="Vendordashboard.jsp">Home</a></strong>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="destination.html" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><p id="name"></p></a>
                <div class="dropdown-menu" aria-labelledby="dropdown04">
                   <a class="dropdown-item" href="busreg.jsp">Business Registration</a>
                   <a class="dropdown-item" href="RegistrationDetails.jsp">Business Status</a>
   ...
   <section class="site-hero overlay" data-stellar-background-ratio="0.5" style="background-image: url(images/bg image.jpg); background-repeat:no-repeat;
background-size:cover,contain;width:1366px;height:70px;">
    ...
    <!-- END section -->
		...
		try {
			...
			if(x==null){
            x = sp.getAttribute("email").toString();
            	//String ex = email;
            }
			...
			while (rs.next()) {
	%>
	       <strong> <div class="container" style="border-style:solid;">
      <h3><strong>Vendor Profile</strong></h3>
     <p class="solid">
