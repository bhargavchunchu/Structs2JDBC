...
<header role="banner">
      <nav class="navbar navbar-expand-md navbar-dark bg-light">
        <div class="container">
          ...
          <div class="collapse navbar-collapse navbar-light" id="navbarsExample05" style="color: red;">
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          <%
                ...
                //String n =request.getParameter("form.email");
                //String ex = sp.getAttribute("e").toString();
                if(email==null){
                ...
                sp.setAttribute("email", new String(email));  
				 try{
					 Class.forName("com.mysql.jdbc.Driver");
						...
						String s = "select name,mobileno from user where email_id=\""+email+"\""; 
     ...
     <section class="site-hero overlay" data-stellar-background-ratio="0.5" style="background-image: url(images/big_image_1.jpg);">
      ...
      <center> <div class="row align-items-center site-hero-inner justify-content-center">
        	  <div class="form-bg">
		   	<form style="height:350px" action = "UpdateProfDetails.jsp">
		   
			<h2>
				<b><font color="black">Edit Profile</font></b>
			</h2>
			
				<input type="text" name="form.name" value= <%= rs.getString(1) %>  id="username"  placeholder="Name" required  onblur="usernamechecking()"> <font color="green">
		<span id="pr1"></span>
		</font>
				
				
 
				<input type="phone" id="phno"  value = <%= rs.getString(2) %>    name="form.phoneno" placeholder="phoneno" required onblur="phnochecking()"><font color="green">
	<span id="pr5"></span></font> <br>
				&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="submit" value="Update Details" class="btn btn-primary" onclick="update()">
